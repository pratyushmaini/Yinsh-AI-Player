...
float Board::all_utility()
{
    ...
    float score=0;
    int rh_gap = 0; int rh_gap_opp = 0;
    int rv_gap = 0; int rv_gap_opp = 0;
            ...
            if(non_intersecting_rows.size() > 0)
                {
                    ...
                    for(int i=0;i<non_intersecting_rows.size();i++)
                    {
                        ...
                        ct_first.push_back(non_intersecting_rows[i].carts[1]);
                        ct_first.push_back(non_intersecting_rows[i].carts[2]);
                        // cerr << non_intersecting_rows[i].carts[0].x << " " <<non_intersecting_rows[i].carts[0].y <<
                        // " " << non_intersecting_rows[i].carts[1].x << " " << non_intersecting_rows[i].carts[1].y << 
                        // " " << non_intersecting_rows[i].carts[2].x << " " << non_intersecting_rows[i].carts[2].y << endl;
                        ...
                        for(int j=i+1;j<non_intersecting_rows.size();j++)
                        {
                            ...
                            if(check_if_row(non_intersecting_rows[j].carts[0].x, 
                                            ...
                                            my_turn) ==0)
                            {
                                // cerr << non_intersecting_rows[j].carts[0].x << " " <<non_intersecting_rows[j].carts[0].y <<
                                //             " " << non_intersecting_rows[j].carts[1].x << " " << non_intersecting_rows[j].carts[1].y << 
                                //             " " << non_intersecting_rows[j].carts[2].x << " " << non_intersecting_rows[j].carts[2].y << endl;
